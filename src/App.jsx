  ...
  return (
    ...
    >
        ...
        <div className="w-full my-24">
          <div className="w-full max-w-lg mx-auto border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white/30 mb-10">
          <h1 className="text-white text-4xl font-semibold flex justify-center">Currency Converter</h1>
          </div>
